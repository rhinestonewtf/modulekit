...
import "../../integrations/interfaces/chainlink/IFeedRegistry.sol";
import "../../integrations/interfaces/chainlink/IAggregatorV3.sol";
import "../../integrations/interfaces/aaveV2/ILendingPoolAddressesProviderV2.sol";
import "../../integrations/interfaces/aaveV2/IPriceOracleGetterAave.sol";

import "../../integrations/interfaces/lido/IWStEth.sol";
import "../../integrations/Denominations.sol";

contract ChainlinkTokenPrice {
    ...
    function getChainlinkPriceInUSD(
        address _inputTokenAddr,
        bool _useFallback
    )
        public
