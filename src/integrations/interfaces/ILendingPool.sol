...
abstract contract ILendingPool {
    ...
    function getReserveData(address _reserve)
        ...
        returns (
            ...
            uint256 liquidityRate, // current deposit APY of the reserve for depositors, in Ray
                // units.
            uint256 variableBorrowRate, // current variable rate APY of the reserve pool, in Ray
                // units.
    ...
    function getUserAccountData(address _user)
        ...
        returns (
            ...
            uint256 totalCollateralETH, // user aggregated collateral across all the reserves. In
                // Wei
            uint256 totalBorrowsETH, // user aggregated outstanding borrows across all the reserves.
                // In Wei
            uint256 totalFeesETH, // user aggregated current outstanding fees in ETH. In Wei
            uint256 availableBorrowsETH, // user available amount to borrow in ETH
            uint256 currentLiquidationThreshold, // user current average liquidation threshold
                // across all the collaterals deposited
