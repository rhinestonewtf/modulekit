...
import {ERC7579BootstrapConfig, IERC7579Account, ERC7579Account, ERC7579AccountFactory, IERC7579Validator} from "../external/ERC7579.sol";
...
contract RhinestoneModuleKit is AuxiliaryFactory {
    ...
    ) internal returns (AccountInstance memory instance) {
    ...
    //         validators = new ERC7579BootstrapConfig[](1);
    ...
    //     // break
    //     if (
    //         validators[0].module != address(0) &&
    //         validators[0].module != address(defaultValidator)
    //     ) {
    //         ERC7579BootstrapConfig[]
    //             memory _validators = new ERC7579BootstrapConfig[](
    //                 validators.length + 1
    //             );
    //         _validators[0] = ERC7579BootstrapConfig({
    ...
    //     bytes memory bootstrapCalldata = accountFactory.getBootstrapCallData(
    //         validators,
    //         executors,
    //         hook,
    //         fallBacks
    ...
    //     bytes memory createAccountOnFactory = abi.encodeCall(
    //         accountFactory.createAccount,
    //         (salt, bootstrapCalldata)
    //     );
    ...
    function makeAccountInstance(
        ...
        bytes memory minimalInitData = accountFactory.getMinimalInitData(
