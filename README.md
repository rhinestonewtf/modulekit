...
- **Easily build smart account modules** with interfaces and examples for:
  - Validators
  - Executors
  - Hooks
...
- **Calculate gas costs** on L1 and L2 for your modules using a dedicated helper library
- **Deploy and distribute** your modules using a dedicated script
